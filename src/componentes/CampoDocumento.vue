...
const { mascarado, valido: validoInterno, aoDigitar } = useDocumento(modelo)
...
function aoInput(evento: Event): void {
  aoDigitar(evento)
  // Trata o "caractere fantasma": caracteres digitados que não alteram o valor
  // limpo (letras num CPF, dígitos além do limite) não devem ficar na tela.
